...
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js get-content --docKey=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js search --workspaceId=YRBGvyxxx --keyword="需求"
```
...
```bash
# Linux / macOS
node ~/.openclaw/skills/dingtalk-knowledge/scripts/index.js create-doc --workspaceId=YRBGvyxxx --name="新文档" --docType=DOC --parentNodeId=root
node ~/.openclaw/skills/dingtalk-knowledge/scripts/index.js update-content --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --content="# 标题\n\n内容"
node ~/.openclaw/skills/dingtalk-knowledge/scripts/index.js update-content --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --docKey=真实docKey --content="# 标题\n\n内容"
node ~/.openclaw/skills/dingtalk-knowledge/scripts/index.js delete-doc --workspaceId=YRBGvyxxx --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz

# Windows PowerShell
# 创建文档
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js create-doc --workspaceId=YRBGvyxxx --name="新文档" --docType=DOC --parentNodeId=root
# 返回：{ "docKey": "abc123", "nodeId": "xyz789", ... }

# 更新文档内容（整篇覆写，替换全部内容）
# ✅ 推荐：只用 nodeId（大多数情况够用）
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js update-content --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --content="# 标题\n\n内容"

# ✅ 备选：如果上面失败，传入真实的 docKey
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js update-content --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --docKey=真实 docKey --content="# 标题\n\n内容"

# 删除文档
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js delete-doc --workspaceId=YRBGvyxxx --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz
```
...
```bash
# Linux / macOS
node ~/.openclaw/skills/dingtalk-knowledge/scripts/index.js append-text --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --blockId=blk123 --text="追加的内容"
node ~/.openclaw/skills/dingtalk-knowledge/scripts/index.js delete-block --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --blockId=blk123
node ~/.openclaw/skills/dingtalk-knowledge/scripts/index.js modify-block --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --blockId=blk123 --element='{"type":"paragraph","content":"新内容"}'
node ~/.openclaw/skills/dingtalk-knowledge/scripts/index.js insert-block --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --element='{"type":"paragraph","content":"插入的内容"}' --position=3

# Windows PowerShell
# 追加文本到段落（在现有段落末尾添加文字）
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js append-text --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --blockId=blk123 --text="追加的内容"

# 删除块元素（删除某个段落/标题/列表项）
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js delete-block --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --blockId=blk123

# 修改块元素（替换单个块的内容，不影响其他部分）
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js modify-block --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --blockId=blk123 --element='{"type":"paragraph","content":"新内容"}'

# 插入块元素（在指定位置插入新段落/标题等）
node $env:USERPROFILE\.openclaw\skills\dingtalk-knowledge\scripts\index.js insert-block --nodeId=YQBnd5ExVE0PDnezU2PK2RK6WyeZqMmz --element='{"type":"paragraph","content":"插入的内容"}' --position=3
```
...
- `element`: 块元素 JSON 对象（**会自动解析**，直接传 JSON 字符串即可）
  - 示例：`--element='{"type":"paragraph","content":"新内容"}'`
...
| 在段落后追加文字 | `append-text --nodeId=xxx --blockId=blk --text="..."` | 在末尾添加 |
